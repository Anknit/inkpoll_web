...
<head>
    ...
    <title>Complete Registration | Inkpoll</title>
        ...
        <div class="col-xs-12 col-md-8">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" action="accounts/register" id="register-form" method="post" onsubmit="return validateForm()">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="firstname" placeholder="First Name" maxlength="25" required />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-3 text-right">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="lastname" placeholder="Last Name" maxlength="25" required />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-3 text-right">
